...
public class HMHExcelReaderPage extends AbstractPage {
	private static final Logger LOG = LoggerFactory
			.getLogger(HMHExcelReaderPage.class);
	...
	public HMHExcelReaderPage(WebDriver driver) {
		super(driver);
		
	}

	public void setFilePath(String sPath) throws FileNotFoundException {
	...
	public String defGetCellData(String sPath, String sSheetName,String sColName,int iRowNum){
				try{
					...
					// loop to get the column number for the given column name give as the input parameter
					...
					System.out.println("The Data displayed in the Excel file is:"+sData);
					return sData;
					...
					e.printStackTrace();
					return "row "+iRowNum+" or column "+sColName +" does not exist in xls";
				}
	}
