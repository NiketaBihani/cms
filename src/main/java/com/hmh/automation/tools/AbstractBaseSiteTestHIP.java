...
public abstract class AbstractBaseSiteTestHIP {
    private static final Logger LOG = LoggerFactory
            .getLogger(AbstractBaseSiteTestHIP.class);
...
//  @ManagedPages(defaultUrl = "https://alfresco.demo.ixxus.co.uk:8443/share/page/")
    ...
    public String siteName, AssetsFolder, ContentObjectsFolder, LearningBundlesFolder,  SequenceBundlesFolder, ProductObjectsFolder, ProductSetsFolder, ProgramsFolder;
