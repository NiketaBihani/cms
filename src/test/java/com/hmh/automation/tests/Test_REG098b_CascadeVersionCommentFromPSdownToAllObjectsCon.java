...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "Test_REG098b_CascadeVersionCommentFromPSdownToAllObjectsCon.csv", separator = ConstantsHMH.CSV_SEPARATOR)


public class Test_REG098b_CascadeVersionCommentFromPSdownToAllObjectsCon extends com.hmh.automation.tools.AbstractBaseSiteTestNew  {
	@Steps
	...
	String objectName = "TC098a"+ConstantsHMH.PREFIX_PRODUCTSET_NAME;
	...
	@Title("Test_REG098b_Cascade Version Comment From PS down To All Objects Consumer")
	public void test_REG098b_CascadeVersionCommentFromPSdownToAllObjectsCon() {
