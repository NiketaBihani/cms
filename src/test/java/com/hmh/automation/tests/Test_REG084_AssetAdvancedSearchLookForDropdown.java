...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "Test_REG084_AssetAdvancedSearch.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class Test_REG084_AssetAdvancedSearchLookForDropdown extends com.hmh.automation.tools.AbstractBaseSiteTestNew {
...
//
    ...
    searchText,VerifyQuickSearch,type1,lookForOption;
    
    String selAssetAdvanceSearchSelFieldDrop = "Name";
    String conditionInput = "Penguins.jpeg";
    ...
    @Test
    @Title("Test_REG084 - Advance search Asset Advanced, Advance search Asset Advanced")
    public void test_REG084_AssetAdvancedSearchLookForDropdown() {

    	documentLibrarySteps.uploadDocument(ConstantsHMH.TESTDATA_FILES_BASE_PATH_HMH + conditionInput);
       ...
       */
        ...
        shareHeaderSteps.customWait(5);
        //hmhAdvancedSearchSteps.SearchforAssetAdvancedText();
       // hmhAdvancedSearchSteps.SearchforAssetAdvancedText();
        System.out.println("Advsearchverified verified");
      // hmhAdvancedSearchSteps.selectLookForAssetAdvanced();
        
        hmhAdvancedSearchSteps.selectLookFor("Asset Advanced");
		hmhAdvancedSearchSteps.selectAssetAdvanceSearchFieldDrop(selAssetAdvanceSearchSelFieldDrop);
 		   		
  		hmhAdvancedSearchSteps.enterassetAdvancedConditionInput(conditionInput);
  		
  		hmhAdvancedSearchSteps.btnSearchAssetAdvanced();
  		
		shareHeaderSteps.customWait(5);
		searchResultsSteps.isElementPresentInSearchResult(VerifyQuickSearch, 20, 20, false);
