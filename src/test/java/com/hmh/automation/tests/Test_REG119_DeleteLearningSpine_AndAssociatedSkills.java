...
import com.ixxus.ipm.automation.steps.alfresco.myprofile.UserTrashcanSteps;
	...
	@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "Test_REG119_DeleteLearningSpine_AndAssociatedSkills.csv", separator = ConstantsHMH.CSV_SEPARATOR)
	public class Test_REG119_DeleteLearningSpine_AndAssociatedSkills  extends com.hmh.automation.tools.AbstractBaseSiteTestNew {
	    ...
	    @Test
	    @Title("Test REG119 Delete Learning Spine And Associated Skills")
	    public void test_REG119_DeleteLearningSpine_AndAssociatedSkills() {
		 ...
		 // Navigate to Reports - Learning spine to delete the Spine
			hmhShareHeaderSteps.clickOnReports();
	    	hmhShareHeaderSteps.clickOnReportsLearningSpine();
	    	hmhShareHeaderSteps.clickOnDeleteLearningSpine(lsTitle);
	    	hmhShareHeaderSteps.clickOnOkButtonOnDeleteLS();
						
	     // Navigate to learning spine object again and Verify No associations displayed
	    	hmhShareHeaderSteps.loadTheSavedURL(currentOneCMSURL);
			siteHeaderSteps.customWait(5);
			siteHeaderSteps.clickOnDocumentLibraryButton();
			hmhDocumentLibrarySteps.assetFromListClick(ProductSetsFolder);
