...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "Test_REG029_PullFromHabitatNlevel.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class Test_REG029_PullFromHabitatNlevel extends com.hmh.automation.tools.AbstractBaseSiteTestHabitat {
	...
	String objectName = "tc029"+ConstantsHMH.REG_PRODUCTSET_NAME+ConstantsHMH.TODAY_DATE;							// HABITAT_TEST_USER_LOGIN = "cms.engineering@hmhco.com"; HABITAT_TEST_PASS_LOGIN = "habitatToken";
	String sbNameD="tc029sb"+ConstantsHMH.TODAY_DATE, sbName1D="sb"+ConstantsHMH.TODAY_DATE+"1", sbName2D="sb"+ConstantsHMH.TODAY_DATE+"2", sbNameND="updatedSB"+ConstantsHMH.TODAY_DATE;
	String ccoNameD="tc029cco"+ConstantsHMH.TODAY_DATE, ccoName1D="cco"+ConstantsHMH.TODAY_DATE+"1", ccoName2D="cco"+ConstantsHMH.TODAY_DATE+"2", ccoNameND="updatedCCO"+ConstantsHMH.TODAY_DATE;
