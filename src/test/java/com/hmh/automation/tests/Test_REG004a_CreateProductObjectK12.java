...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "Test_REG004a_CreateProductObjectK12.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class Test_REG004a_CreateProductObjectK12 extends com.hmh.automation.tools.AbstractBaseSiteTestNew {
    ...
    String teacherproductLabel = "teacherprodlabel";
    ...
    @Test
    @Title("Test_REG004a - Create ProductObject in K12 Site, Edit Properties and Verify Metadata Properties")
    public void test_REG004_CreateProductSetK12() {
      ...
      //** ALF 2108 ** Create a Second Product Label for Teacher CO/CCOs in Dual-Delivery POs ** Sprint 7.3.2 **
        hmhEditPropertiesSteps.selectTeacherProductLabel(teacherproductLabel);
        hmhEditPropertiesSteps.validateToolTipTeacherProductLabel();
      ...
      //** ALF 2108 ** Create a Second Product Label for Teacher CO/CCOs in Dual-Delivery POs ** Sprint 7.3.2 **
        hmhDocumentDetailsSteps.verifyPropertyValue(ConstantsProprtyLabelsHMH.TEACHER_PRODUCT_LABEL, teacherproductLabel);
