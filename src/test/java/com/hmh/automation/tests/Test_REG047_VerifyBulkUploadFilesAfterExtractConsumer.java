...
public class Test_REG047_VerifyBulkUploadFilesAfterExtractConsumer extends com.hmh.automation.tools.AbstractBaseSiteTestNew {
    ...
    @Test
    @Title("Test_REG047 - Consumer: Bulk Upload of 7 items (jpg, pdf, xls, docx, xml) then extract and verify Metadata for item1 in Consumer site")
    public void test_REG047_VerifyBulkUploadFilesAfterxtractConsumer() {
