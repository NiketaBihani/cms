...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "Test_REG052_POk12EditSequenceReferenceVersionAndPublishToDraftandQA.csv", separator = ConstantsHMH.CSV_SEPARATOR)


public class Test_REG052_POk12EditSequenceReferenceVersionAndPublishToDraftandQA extends com.hmh.automation.tools.AbstractBaseSiteTestNew  {
	@Steps
	...
	@Title("Test_REG052 - Product Object in K-12: EditSequence, Reference, Versioning And PublishToDraft and Publish to QA")
	public void test_REG052_POEditSequenceReferenceVersionAndPublishToDraftandQAinK12() {
