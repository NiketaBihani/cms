...
public class Test_REG017a_K12BulkUploadAndExtract extends com.hmh.automation.tools.AbstractBaseSiteTestNew {
    ...
    @Test
    @Title("Test_REG017a - K12 Bulk Upload of 5 items (jpg, pdf, xls, docx, xml) then extract in K-12 site")
    public void test_REG017a_BulkUploadAndExtractK12() {
