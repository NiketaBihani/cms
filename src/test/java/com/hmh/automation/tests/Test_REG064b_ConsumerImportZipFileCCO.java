...
public class Test_REG064b_ConsumerImportZipFileCCO extends com.hmh.automation.tools.AbstractBaseSiteTestNew {
    ...
    @Test
    @Title("Test_REG064 - Consumer: Import Zip File as CCO")
    public void test_REG064_VerifyImportZipFileforCCOConsumer() {
